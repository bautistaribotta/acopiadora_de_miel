...
def informacion_cliente():
    ...
    for i, label_text in enumerate(labels_datos):
        ...
        # Etiqueta del campo
        lbl_titulo = tk.Label(frame_datos, text=label_text + ":", bg=color_primario, fg="white",
                              font=("Arial", 10, "bold"))
    ...
    for i, valor_text in enumerate(valores):
        ...
        lbl_val = tk.Label(frame_val_item, text="---", bg="white", fg="black", font=("Arial", 11, "bold"), width=10,
                           relief="sunken")
        lbl_val.pack(pady=2)
    ...
    for btn_text in botones:
        ...
        btn = tk.Button(frame_btn_wrapper, text=btn_text, font=("Arial", 10, "bold"), bg="white", fg="black",
                        cursor="hand2")
        btn.pack(fill="x")
